...
public class NormalGameTimerAR : MonoBehaviour
{
    ...
    public NormalGameOverAR normalGameOverARScript;
    ...
    void Update()
    {
        ...
        if(gameTimer <= 0 && milliseconds <=0)
        {
            ...
            enabled = false;
            normalGameModeARScript.DisableScripts();
            normalGameModeARScript.enabled = false;
            normalGameOverARScript.enabled = true;
            battleMusic.Stop();
        }
    }
}
