...
public class NormalDifficultySkewer : MonoBehaviour
{
    public float timer;
    public float restartTimer;
    public NormalPreGameTimerSkewer NormalPreGameTimerSkewerScript;
    ...
    void Update()
    {
        ...
        if(timer <= 0)
        {
            NormalPreGameTimerSkewerScript.enabled = true;
            enabled = false;
        }
    }
}
