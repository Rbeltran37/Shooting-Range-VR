...
public class NormalGameOverSkewer : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        normalGameModeSkewerScript.disableEnemies();
    }
    ...
    {
        if(previousHighestStarsEarned < normalGameModeSkewerScript.starsEarned)
        {
            previousHighestStarsEarned = normalGameModeSkewerScript.starsEarned;
        }
    }
    ...
    {
        if(normalGameModeSkewerScript.starsEarned == 0)
        {
        ...
        else if(normalGameModeSkewerScript.starsEarned == 1)
        {
        ...
        else if(normalGameModeSkewerScript.starsEarned == 2)
        {
            gameOverStars[0].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
        ...
        else if(normalGameModeSkewerScript.starsEarned == 3)
        {
            gameOverStars[0].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
            gameOverStars[1].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
