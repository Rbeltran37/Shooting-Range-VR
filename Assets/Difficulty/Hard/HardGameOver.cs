...
public class HardGameOver : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        hardGameModeScript.disableEnemies();
    }
    ...
    {
        if(previousHighestStarsEarned < hardGameModeScript.starsEarned)
        {
            previousHighestStarsEarned = hardGameModeScript.starsEarned;
        }
    }
    ...
    {
        if(hardGameModeScript.starsEarned == 0)
        {
        ...
        else if(hardGameModeScript.starsEarned == 1)
        {
        ...
        else if(hardGameModeScript.starsEarned == 2)
        {
            gameOverStars[0].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
        ...
        else if(hardGameModeScript.starsEarned == 3)
        {
            gameOverStars[0].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
            gameOverStars[1].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
