...
public class EasyGameOverSkewer : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        easyGameModeSkewerScript.disableEnemies();
    }
    ...
    {
        if(previousHighestStarsEarned < easyGameModeSkewerScript.starsEarned)
        {
            previousHighestStarsEarned = easyGameModeSkewerScript.starsEarned;
        }
    }
    ...
    {
        if(easyGameModeSkewerScript.starsEarned == 0)
        {
        ...
        else if(easyGameModeSkewerScript.starsEarned == 1)
        {
        ...
        else if(easyGameModeSkewerScript.starsEarned == 2)
        {
            gameOverStars[0].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
        ...
        else if(easyGameModeSkewerScript.starsEarned == 3)
        {
            gameOverStars[0].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
            gameOverStars[1].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
