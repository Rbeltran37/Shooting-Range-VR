...
public class EasyGameTimerSkewer : MonoBehaviour
{
    ...
    public EasyGameOverSkewer easyGameOverSkewerScript;
    ...
    void Update()
    {
        ...
        if(gameTimer <= 0 && milliseconds <=0)
        {
            ...
            enabled = false;
            easyGameModeSkewerScript.DisableScripts();
            easyGameModeSkewerScript.enabled = false;
            easyGameOverSkewerScript.enabled = true;
            battleMusic.Stop();
        }
    }
}
