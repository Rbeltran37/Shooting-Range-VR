...
public class NormalGameOver : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        normalGameModeScript.disableEnemies();
    }
    ...
    void Update()
    {
        ...
        if(timerToResetGame <= 0 && !enemiesAndBeamsDisabled)
        {
            ...
            gunInUseScript.pistolGameInProgress = false;
            gunInUseScript.PistolGameEnded();
        }
    }
    ...
    {
        if(previousHighestStarsEarned < normalGameModeScript.starsEarned)
        {
            previousHighestStarsEarned = normalGameModeScript.starsEarned;
        }
    }
    ...
    {
        if(normalGameModeScript.starsEarned == 0)
        {
        ...
        else if(normalGameModeScript.starsEarned == 1)
        {
        ...
        else if(normalGameModeScript.starsEarned == 2)
        {
            gameOverStars[0].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
        ...
        else if(normalGameModeScript.starsEarned == 3)
        {
            gameOverStars[0].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
            gameOverStars[1].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
