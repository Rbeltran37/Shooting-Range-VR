...
public class NormalGameTimer : MonoBehaviour
{
    ...
    public NormalGameOver normalGameOverScript;
    ...
    void Update()
    {
        ...
        if(gameTimer <= 0 && milliseconds <=0)
        {
            ...
            enabled = false;
            normalGameModeScript.DisableScripts();
            normalGameModeScript.enabled = false;
            normalGameOverScript.enabled = true;
            battleMusic.Stop();
        }
    }
}
