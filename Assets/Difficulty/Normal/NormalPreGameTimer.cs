...
public class NormalPreGameTimer : MonoBehaviour
{
    ...
    public NormalGameTimer normalGameTimerScript;
    ...
    void Update()
    {
        ...
        if(CountdownToStart <= 0 && milliseconds <=0)
        {
            ...
            normalGameModeScript.enabled = true;
            normalGameTimerScript.enabled = true;
            enabled = false;
        }
    }
