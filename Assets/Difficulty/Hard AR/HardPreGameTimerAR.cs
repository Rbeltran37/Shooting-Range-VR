...
public class HardPreGameTimerAR : MonoBehaviour
{
    ...
    public HardGameTimerAR hardGameTimerARScript;
    ...
    void Update()
    {
        ...
        if(CountdownToStart <= 0 && milliseconds <=0)
        {
            ...
            hardGameModeARScript.enabled = true;
            hardGameTimerARScript.enabled = true;
            enabled = false;
        }
    }
