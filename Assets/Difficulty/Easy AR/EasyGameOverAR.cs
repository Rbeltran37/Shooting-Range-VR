...
public class EasyGameOverAR : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        easyGameModeARScript.disableEnemies();
    }
    ...
    {
        if(previousHighestStarsEarned < easyGameModeARScript.starsEarned)
        {
            previousHighestStarsEarned = easyGameModeARScript.starsEarned;
        }
    }
    ...
    {
        if(easyGameModeARScript.starsEarned == 0)
        {
        ...
        else if(easyGameModeARScript.starsEarned == 1)
        {
        ...
        else if(easyGameModeARScript.starsEarned == 2)
        {
            gameOverStars[0].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
        ...
        else if(easyGameModeARScript.starsEarned == 3)
        {
            gameOverStars[0].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
            gameOverStars[1].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
