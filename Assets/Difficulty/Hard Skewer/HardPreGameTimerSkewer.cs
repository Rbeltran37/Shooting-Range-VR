...
public class HardPreGameTimerSkewer : MonoBehaviour
{
    ...
    public HardGameTimerSkewer hardGameTimerSkewerScript;
    ...
    void Update()
    {
        ...
        if(CountdownToStart <= 0 && milliseconds <=0)
        {
            ...
            hardGameModeSkewerScript.enabled = true;
            hardGameTimerSkewerScript.enabled = true;
            enabled = false;
        }
    }
