...
public class HardGameTimerSkewer : MonoBehaviour
{
    ...
    public HardGameOverSkewer hardGameOverSkewerScript;
    ...
    void Update()
    {
        ...
        if(gameTimer <= 0 && milliseconds <=0)
        {
            ...
            enabled = false;
            hardGameModeSkewerScript.DisableScripts();
            hardGameModeSkewerScript.enabled = false;
            hardGameOverSkewerScript.enabled = true;
            battleMusic.Stop();
        }
    }
}
