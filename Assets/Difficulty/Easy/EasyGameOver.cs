...
public class EasyGameOver : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        easyGameModeScript.disableEnemies();
    }
    ...
    {
        if(previousHighestStarsEarned < easyGameModeScript.starsEarned)
        {
            previousHighestStarsEarned = easyGameModeScript.starsEarned;
        }
    }
    ...
    {
        if(easyGameModeScript.starsEarned == 0)
        {
        ...
        else if(easyGameModeScript.starsEarned == 1)
        {
        ...
        else if(easyGameModeScript.starsEarned == 2)
        {
            gameOverStars[0].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
        ...
        else if(easyGameModeScript.starsEarned == 3)
        {
            gameOverStars[0].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
            gameOverStars[1].GetComponent<Renderer>().material = gameOverEarnedStarMaterial;
