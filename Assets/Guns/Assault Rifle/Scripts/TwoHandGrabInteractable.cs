...
public class TwoHandGrabInteractable : XRGrabInteractable
{
    ...
    public void OnSecondHandGrab(XRBaseInteractor interactor)
    {
        ...
        bothHandsOnGun = true;
        assaultRifleScript.secondaryHand = interactor.gameObject.GetComponent<XRDirectInteractor>();
    }
    ...
    protected override void OnSelectEntered(XRBaseInteractor interactor)
    {
        ...
        assaultRifleScript.primaryHand = interactor.gameObject.GetComponent<XRDirectInteractor>();
    }
